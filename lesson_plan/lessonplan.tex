...
Here I will provide screenshots of all of the criterion layers before the MCE calculation, just to make sure you are on the right track. Figure \ref{3_final} is my final map. I have used multiple data frames to show the geographic area to the viewer more clearly. 
