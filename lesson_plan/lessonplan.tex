...
realise you need only mainland

select by attributes

export selection (add layer to map)

select by location again

open attribute table, view selection

right click on 2018 pop, view statistics (should be around 280,000)

do another buffer for 2.5 km and 10km (show how to do dissolve during buffer)
